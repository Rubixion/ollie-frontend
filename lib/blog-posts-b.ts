...
export const postsB: BlogPost[] = [
  {
    ...
    keywords: ["unfamiliar face matching", "how do humans recognize faces", "face recognition humans", "familiar faces", "face perception", "AI face matching"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Psychology",
    author: "Ollie Research Team",
    keywords: ["prosopagnosia", "face blindness", "face blindness symptoms", "prosopagnosia causes", "fusiform face area", "face recognition"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Psychology",
    author: "Ollie Research Team",
    keywords: ["pareidolia", "why do i see faces in things", "face pareidolia", "pareidolia meaning", "face detection", "brain"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Psychology",
    author: "Ollie Research Team",
    keywords: ["own-race effect", "cross-race effect", "other-race effect", "face recognition", "eyewitness identification", "AI bias"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Psychology",
    author: "Ollie Research Team",
    keywords: ["why do i look different in photos than in the mirror", "mirror vs photo", "why do i look different in photos", "self-face recognition", "face perception", "celebrity match"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Psychology",
    author: "Ollie Research Team",
    keywords: ["baby face features", "baby face celebrities", "baby face", "facial proportions", "celebrity match", "face perception"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Psychology",
    author: "Ollie Research Team",
    keywords: ["resting face", "resting face expression", "neutral expression", "celebrity match", "face recognition", "facial expression"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Psychology",
    author: "Ollie Research Team",
    keywords: ["how does the brain recognize faces", "fusiform face area", "N170", "face perception", "face recognition", "neuroscience"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Psychology",
    author: "Ollie Research Team",
    keywords: ["uncanny valley", "uncanny valley AI faces", "uncanny valley effect", "Masahiro Mori", "AI-generated faces", "face perception"],
    sections: [
      {
  ...
  },
  {
    ...
    summary: "The best photo for a celebrity lookalike match is sharp and front-facing, in even light, taken with the rear camera from at least 50 to 60 cm away, with a neutral expression and no glasses. These conditions let face recognition read your real proportions. Avoid heavy filters, group shots, strong shadows and screenshots.",
    date: "April 2026",
    isoDate: "2026-04-08",
    readTime: "4 min read",
    category: "Guide",
    author: "Ollie Research Team",
    keywords: ["celebrity look alike photo", "best photo for face recognition", "celebrity lookalike", "photo tips", "face match", "selfie"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Guide",
    author: "Ollie Research Team",
    keywords: ["best lighting for selfies", "best lighting for face photos", "good lighting for selfies", "photo lighting", "celebrity match", "face recognition"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Guide",
    author: "Ollie Research Team",
    keywords: ["does face recognition work with glasses", "face recognition glasses", "sunglasses", "hats", "hairstyles", "celebrity match"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Guide",
    author: "Ollie Research Team",
    keywords: ["front camera vs back camera", "which camera shows your real face", "selfie camera vs back camera", "lens distortion", "face matching", "celebrity match"],
    sections: [
      {
  ...
  },
  {
    ...
    summary: "Facial recognition accuracy varies by race, sex and age. NIST's 2019 test of 189 algorithms found many made 10 to 100 times more false matches on West African, East African and East Asian faces than on Eastern European faces. The main cause is unbalanced training data; the best algorithms show much smaller gaps, but none is perfectly even.",
    date: "March 2026",
    updatedIsoDate: "2026-09-23",
    isoDate: "2026-03-30",
    readTime: "5 min read",
    category: "Ethics",
    author: "Ollie Research Team",
    keywords: ["facial recognition accuracy by race", "how accurate is facial recognition", "facial recognition bias", "NIST FRVT", "demographic differentials", "face recognition"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Ethics",
    author: "Ollie Research Team",
    keywords: ["facial recognition bias", "bias in facial recognition", "AI bias", "training data", "fairness", "face recognition"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Ethics",
    author: "Ollie Research Team",
    keywords: ["facial recognition privacy concerns", "facial recognition privacy", "biometric data", "face data", "privacy", "celebrity lookalike"],
    sections: [
      {
  ...
  },
  {
    ...
    summary: "Woody Bledsoe built the first facial recognition system in the 1960s, entering face landmarks by hand. The field then moved to eigenfaces in the 1990s, hand-designed features like LBP and HOG in the 2000s, and deep learning from 2012 onward, which brought machines to human-level accuracy on benchmarks.",
    date: "March 2026",
    isoDate: "2026-03-24",
    readTime: "5 min read",
    category: "History",
    author: "Ollie Research Team",
    keywords: ["history of facial recognition", "who invented facial recognition", "Woody Bledsoe", "eigenfaces", "deep learning", "facial recognition technology"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Machine Learning",
    author: "Ollie Research Team",
    keywords: ["face recognition training data", "face recognition dataset", "training data", "MS1MV2", "dataset diversity", "deep learning"],
    sections: [
      {
  ...
  },
  {
    ...
    summary: "An AI confidence score is not the same as accuracy: a 95% match means two face embeddings are very close, not that there is a 95% chance the result is right. A score only equals accuracy when the model is calibrated, and celebrity lookalike scores are not. Treat the score as a ranking signal.",
    date: "March 2026",
    updatedIsoDate: "2026-09-23",
    isoDate: "2026-03-16",
    readTime: "4 min read",
    category: "Machine Learning",
    author: "Ollie Research Team",
    keywords: ["AI confidence score", "confidence vs accuracy", "calibration", "similarity score", "celebrity match percentage", "machine learning"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Guide",
    author: "Ollie Research Team",
    keywords: ["does smiling affect face recognition", "facial expression", "neutral expression", "celebrity match", "face recognition", "smile"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Guide",
    author: "Ollie Research Team",
    keywords: ["does makeup affect face id", "makeup facial recognition", "makeup", "contouring", "celebrity match", "face recognition"],
    sections: [
      {
