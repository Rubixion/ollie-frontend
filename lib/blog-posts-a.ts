...
export const postsA: BlogPost[] = [
  {
    ...
    sections: [
      ...
      {
        h2: "Step 1: Finding and Straightening the Face",
        paragraphs: [
          "A face detector (Ollie uses <strong>InsightFace</strong>) scans the photo for faces and picks the largest one. It also finds five landmarks: the centres of both eyes, the tip of the nose, and the two corners of the mouth.",
          "Those five points are used to <strong>align</strong> the face: the image is rotated, scaled and cropped so the eyes are level and sit in the same place in a small 112 × 112 pixel square. Every face the network ever sees, in training and in your search, is lined up the same way, so it can focus on the shape of the face instead of where it happens to be in the photo.",
        ],
      },
      {
        h2: "Step 2: A Convolutional Network Reads the Face",
        paragraphs: [
          "The aligned face goes through a <strong>convolutional neural network</strong> (CNN). Ollie's is a 20-layer network in the SphereFace style, with residual connections that let information skip past layers so a deep network still trains well.",
      ...
      {
        h2: "Step 3: How the Network Learned to Tell Faces Apart",
        paragraphs: [
          "Ollie's network was trained from scratch on <strong>MS1MV2</strong>, a research dataset of about 5.8 million photos of 85,742 people. Training took around 10 days on a single NVIDIA RTX 4060 Ti graphics card.",
          "It was trained with the <strong>CosFace</strong> loss. During training the network has to say which of the 85,742 people is in each photo, but the loss adds a margin: the correct answer must win by a clear angle, not just barely. That pressure pushes photos of the same person into a tight cluster and different people far apart, which is exactly what makes the fingerprints useful for comparing faces the network has never seen.",
          "To check it, the model was tested on the <strong>Labeled Faces in the Wild (LFW)</strong> benchmark, with every LFW person removed from the training data first. It scored 98.5% at deciding whether two photos show the same person.",
        ],
      },
      {
      ...
      {
        h2: "Step 5: From Distance to a Percentage",
        paragraphs: [
      ...
      {
        h2: "Why Results Change Between Photos",
        paragraphs: [
    ...
    faqs: [
      { q: "How does AI facial recognition work in simple terms?", a: "A neural network turns a photo of a face into a list of numbers (a facial fingerprint). Photos of similar-looking people give similar lists, so finding a lookalike means finding the celebrity fingerprints closest to yours." },
      { q: "What neural network does Ollie use?", a: "A 20-layer SphereFace-style convolutional neural network, trained from scratch on the MS1MV2 dataset with the CosFace loss. It scored 98.5% on the LFW benchmark." },
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Landmarks: Lining the Face Up First",
        paragraphs: [
          "Before the network sees a face, a detector finds five <strong>facial landmarks</strong>: the centres of both eyes, the tip of the nose and the two corners of the mouth. Ollie uses InsightFace for this. The landmarks are used to rotate and scale the face into a standard 112 × 112 crop, so every face is compared in the same position.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "A well-trained AI system operating on face embeddings consistently exceeds human performance on standard benchmarks. On <strong>LFW (Labeled Faces in the Wild)</strong>, the industry-standard benchmark of realistic face pairs, modern models achieve above 99% accuracy, far beyond the human ceiling. The advantage is not intelligence but consistency: the same mathematical operation applied identically to every image, without fatigue or attentional variation.",
        ],
      },
    ],
    faqs: [
      { q: "What facial features does AI use to match faces?", a: "AI face recognition networks learn features implicitly through training, focusing on structural geometry: inter-ocular distance, nose bridge width, jaw angle, and other proportions that remain stable across conditions." },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "A fully connected layer then maps this pooled vector to the final 512-dimensional embedding space, and <strong>L2 normalisation</strong> places the result on the unit hypersphere. At this point, all spatial structure from the original image is gone. What remains is a coordinate in a high-dimensional space that encodes identity, not appearance. Two photos of the same person, regardless of lighting or angle, will land near the same coordinate in this space.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The vectors are <strong>L2-normalised</strong>, placing them all on the surface of a 512-dimensional unit sphere. Comparing any two normalised vectors reduces to computing cosine similarity, the angle between two points on the sphere's surface. This makes comparison both mathematically clean and extremely fast, which is essential for searching a database of thousands of celebrities in real time.",
        ],
      },
      {
        h2: "Searching Thousands of Faces in Milliseconds",
        paragraphs: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Why the Shared Weights Matter",
        paragraphs: [
      ...
      {
        h2: "How Siamese Networks Are Trained",
        paragraphs: [
          "The classic way to train a Siamese network is with pairs. <strong>Contrastive loss</strong> shows the network two examples labelled same or different, pulling same pairs together and pushing different pairs at least a set margin apart. <strong>Triplet loss</strong> uses an anchor, a matching example and a non-matching one, and asks the match to be closer to the anchor than the non-match by a margin.",
      ...
      {
        h2: "Siamese Networks in Face Recognition",
        paragraphs: [
          ...
          "Later research found a more stable route to the same goal. Losses such as <strong>SphereFace</strong> (2017), <strong>CosFace</strong> (2018) and <strong>ArcFace</strong> (2019) train the network to classify thousands of people with an extra margin, then throw the classifier away and keep the embedding. The result is used exactly like one branch of a Siamese network: embed two faces, measure the distance.",
        ],
      },
      {
        h2: "How Ollie Relates to the Siamese Idea",
        paragraphs: [
    ...
    faqs: [
      { q: "Why is it called a Siamese network?", a: "Because it is drawn as two identical networks side by side, like twins. In reality it is one network with shared weights, applied to both inputs." },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "As a rough guide, the higher the score, the stronger the <strong>facial similarity</strong>, and a clear gap between your #1 and #2 matches means more than the exact numbers. Treat any cut-off, such as \"above 75% is strong\", as a loose rule of thumb, not a measured threshold.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Ollie turns the face in your photo into a list of 512 numbers, a facial fingerprint, and compares it with the fingerprints of thousands of celebrity photos. The five celebrities whose fingerprints are closest to yours are your matches. The photo you choose matters more than anything else, so most of this guide is about picking a good one.",
        ],
      },
      {
        h2: "Choose the Right Photo",
        paragraphs: [
          "Use a photo where your face is <strong>front-facing</strong>, fills a good part of the frame, and is the only face in the picture. If there are several people, Ollie matches the largest face, which may not be yours.",
          "Take off sunglasses, move hair away from your eyes if you can, and skip heavy beauty filters or face-slimming effects: they change the shape the network sees. A plain, recent selfie usually beats a dramatic photo.",
        ],
      },
      {
        h2: "Get the Lighting Right",
        paragraphs: [
          "Soft, even light is best: facing a window in daylight, or outside in open shade. Strong light from one side throws shadows that hide half the face, and very dark photos lose detail around the eyes and jaw.",
          "Avoid bright light directly behind you, which turns your face into a silhouette. If a photo looks grainy or blurry when you zoom in, the network will struggle with it too.",
        ],
      },
      {
      ...
      {
        h2: "Read Your Results",
        paragraphs: [
          "You get your top five matches, each with the celebrity's photo that matched you best and a percentage. The percentage is a rescaled similarity score: it is good for comparing your matches with each other, but it isn't a probability and doesn't mean you share anyone's identity.",
          "Every celebrity photo comes from Wikimedia Commons under a free license, and the photographer is credited under each result. Tap a photo to see it larger.",
        ],
      },
      {
        h2: "Try More Than One Photo",
        paragraphs: [
          "Different photos of the same person can give different matches, because lighting, angle and expression all change the fingerprint. Try two or three good photos. The names that keep coming back are your most reliable lookalikes.",
        ],
      },
      {
        h2: "Your Privacy",
        paragraphs: [
          "Your photo is used only to run the search. It is processed in memory and discarded when the search finishes: Ollie doesn't store it, keep your face fingerprint, or use it for training.",
        ],
      },
    ],
    faqs: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Ollie's network was trained on MS1MV2, which covers tens of thousands of people photographed in many different conditions. But dataset asymmetry is unavoidable at scale: more prominent celebrities simply have more available photographs across more varied conditions.",
        ],
      },
      {
