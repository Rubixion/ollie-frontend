        ...
        <div className="max-w-3xl mx-auto px-6 pt-32 pb-20">
          ...
          <div className="prose prose-invert max-w-none space-y-10 text-white/60 leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-3"><strong className="text-white/80">Share cards:</strong> if you make a card to share your match, it is created entirely in your browser. Nothing is uploaded to us or stored. Your own photo appears on the card only if you tick the box to include it.</p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li><strong className="text-white/80">Your signup choices:</strong> When you sign up, we record that you confirmed you are 18 or older and agreed to our Terms of Service and this Privacy Policy, with the date and the version you agreed to, and whether you chose to receive emails from us.</li>
                ...
                <li><strong className="text-white/80">Website analytics:</strong> We use Cloudflare Web Analytics, which does not use cookies or track you across sites. It records the page you visited, the page that linked you there, your browser and device type, your country, and how fast the page loaded.</li>
                ...
                <li><strong className="text-white/80">Cookies and local storage:</strong> We store only what is needed to keep you signed in, plus your signup choices for a moment while you sign in with Google. We do not use advertising or tracking cookies.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li><strong className="text-white/80">Cloudflare:</strong> hosts the website, delivers pages to you, and provides our cookieless website analytics.</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li><strong className="text-white/80">Website analytics:</strong> kept by Cloudflare in aggregate form for its standard retention period.</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Public information from <a href="https://www.wikidata.org/" target="_blank" rel="noopener noreferrer" className={link}>Wikidata</a>: name, a short description of what the person is known for, and gender as recorded there (used only for the &quot;Male&quot; and &quot;Female&quot; filters; we never guess anyone&apos;s gender from your photo).</li>
              </ul>
