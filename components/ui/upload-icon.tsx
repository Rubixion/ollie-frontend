// upload - from AnimateIcons / Lucide (https://animateicons.in)
  ...
  (
    ...
    const headVariants: Variants = {
      ...
      animate: {
        ...
        scale: [1, 1.05, 1],
        opacity: [0.6, 1],
        transition: { duration: 0.6 * duration, ease: "easeInOut", delay: 0.05 },
      },
    };
    ...
    const trayVariants: Variants = {
      ...
      animate: {
        ...
        opacity: [0.3, 1],
        transition: { duration: 0.6 * duration, ease: "easeInOut", delay: 0.1 },
      },
    };
