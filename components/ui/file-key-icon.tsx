// file key - from AnimateIcons / Lucide (https://animateicons.in)
...
interface FileKeyIconProps extends Omit<
...
const FileKeyIcon = forwardRef<FileKeyIconHandle, FileKeyIconProps>(
  (
    ...
    const keyOrigin = { transformBox: "view-box", originX: "4px", originY: "20px" } as const;
      ...
      <LazyMotion features={domMin} strict>
        ...
        >
          ...
          >
            ...
            <m.path d="M4 12v6" variants={keyVariants} style={keyOrigin} />
            <m.path d="M4 14h2" variants={keyVariants} style={keyOrigin} />
            <m.circle cx="4" cy="20" r="2" variants={keyVariants} style={keyOrigin} />
          </m.svg>
        </m.div>
      </LazyMotion>
    );
